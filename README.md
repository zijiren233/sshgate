...
| `ENABLE_PROXY_JUMP` | `true` | Enable ProxyJump mode |
...
ssh myuser@<GATEWAY_HOST> -p 2222 -i ~/.ssh/your_private_key

# The gateway automatically routes to the corresponding Devbox based on public key
```
